...
import { r as requireReact, a as reactExports, R as React, b as reactDomExports, c as ReactDOM, d as React$1 } from "./react-vendor.js";
...
var Menu = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root2$2, __spreadProps(__spreadValues({}, popperScope), { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuContent = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$1.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$1.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? /* @__PURE__ */ jsxRuntimeExports.jsx(MenuRootContentModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) : /* @__PURE__ */ jsxRuntimeExports.jsx(MenuRootContentNonModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) }) }) });
  }
);
...
var MenuGroup = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive.div, __spreadProps(__spreadValues({ role: "group" }, groupProps), { ref: forwardedRef }));
  }
);
...
var MenuLabel = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive.div, __spreadProps(__spreadValues({}, labelProps), { ref: forwardedRef }));
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Collection$1.ItemSlot,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Item$1, __spreadProps(__spreadValues({ asChild: true }, rovingFocusGroupScope), { focusable: !disabled, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Primitive.div,
          __spreadProps(__spreadValues({
            role: "menuitem",
...
var MenuRadioGroup = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupProvider, { scope: props.__scopeMenu, value, onValueChange: handleValueChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MenuGroup, __spreadProps(__spreadValues({}, groupProps), { ref: forwardedRef })) });
  }
);
...
var DropdownMenu = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    DropdownMenuProvider,
    {
      ...
      onOpenToggle: reactExports.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
      modal,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Root3, __spreadProps(__spreadValues({}, menuScope), { open, onOpenChange: setOpen, dir, modal, children }))
    }
  );
};
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1, __spreadValues(__spreadValues({}, menuScope), portalProps));
};
...
var DropdownMenuLabel = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, __spreadProps(__spreadValues(__spreadValues({}, menuScope), labelProps), { ref: forwardedRef }));
  }
);
...
var DropdownMenuItem = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Item2$1, __spreadProps(__spreadValues(__spreadValues({}, menuScope), itemProps), { ref: forwardedRef }));
  }
);
...
var DropdownMenuRadioGroup = reactExports.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroup, __spreadProps(__spreadValues(__spreadValues({}, menuScope), radioGroupProps), { ref: forwardedRef }));
});
...
var DropdownMenuArrow = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Arrow2, __spreadProps(__spreadValues(__spreadValues({}, menuScope), arrowProps), { ref: forwardedRef }));
  }
);
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root2$2, __spreadProps(__spreadValues({}, popperScope), { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
